...
export default defineNuxtConfig({
    app: {
        ...
        meta: [
          ...
          { name: 'owner', content: 'https://ibrahim.elias-designer.com' },
          ...
          { name: 'contactOrganization', content: 'https://ibrahim.elias-designer.com' },
          ...
          { name: 'contactNetworkAddress', content: 'https://ibrahim.elias-designer.com' },
          { name: 'msapplication-starturl', content: 'https://ibrahim.elias-designer.com' },
